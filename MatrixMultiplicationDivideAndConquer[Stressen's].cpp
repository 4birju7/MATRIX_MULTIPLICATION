...
int **multiply(int **A, int **B, int n)
{
    ...
    */
	...
	int** M1 = multiply(A11, sub(B12, B22, n/2), n/2);
	...
	int** M6 = multiply(sub(A12, A22, n/2), add(B21, B22, n/2), n/2);
	int** M7 = multiply(sub(A11, A21, n/2), add(B11, B12, n/2), n/2);

	/* Four Splitted Product Matrices *
    ...
    */
	...
	int** P11 = sub(add(add(M5, M4, n/2), M6, n/2), M2, n/2);
	int** P12 = add(M1, M2, n/2);
	int** P21 = add(M3, M4, n/2);
	int** P22 = sub(sub(add(M5, M1, n/2), M3, n/2), M7, n/2);
